...
public class TwitterClient extends OAuthBaseClient {
	...
	public void getCurrentUser(AsyncHttpResponseHandler httpResponseHandler){
		String apiUrl= getApiUrl("account/verify_credentials.json");
		RequestParams params= new RequestParams();
		client.get(apiUrl, params, httpResponseHandler);

	}

	public void replyTweet(int id, AsyncHttpResponseHandler handler){
